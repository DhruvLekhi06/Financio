...
const SignUpPage: React.FC = () => {
  ...
  return (
    <div className="text-gray-300 font-sans antialiased relative min-h-screen flex items-center justify-center isolate py-16">
      <AnimatedBackground />
      ...
      >
        ...
        <div className="space-y-4">
            <Button 
                ...
                className="w-full py-3 text-base font-semibold bg-white text-gray-800 hover:bg-gray-200"
                disabled={isLoading}
            >
